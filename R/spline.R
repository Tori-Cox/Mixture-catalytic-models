...
## The code below is from https://rdrr.io/github/TeaKov/serostat/src/R/mpsplinefit.R
## We are using the mpspline.fit function from the serostat package, ref: Thomas Kovac, 2018
